# test_6_transient_recording_with_RTDP.py
...
# PJ 2025-11-15, 2025-11-16 100kSps demo with RTDP active.
...
def main(sp, node_id):
    ...
    #
    print("Example of a recording with RTDP active.")
    ...
    start = time.time()
    my_data = daq_mcu.fetch_SRAM_data(n_select=250, n_pretrigger=50)
...
if __name__ == '__main__':
    ...
    # $ python3 test_6_transient_recording_with_RTDP.py -i E
    import argparse
