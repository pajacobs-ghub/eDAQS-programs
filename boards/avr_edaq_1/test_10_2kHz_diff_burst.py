# test_9_2kHz_diff_burst.py
# Example for collecting two (differential) channels of data with burst-mode sampling.
# PJ 2024-10-12, 2025-11-08
#
...
def main(sp, node_id):
    ...
    daq_mcu.set_sample_period_us(500)
    ...
    while not ready:
        print('Waiting for DAQ_MCU to finish recording...')
        time.sleep(1.0)
        ready = node1.test_DAQ_MCU_is_ready()
    #
