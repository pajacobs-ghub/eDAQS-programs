...
This directory contains example Python code for supervising the AVR-eDAQ-1 board.
...
- COMMS-MCU commands and higher-level functions (`../comms_mcu/pic18f16q41_comms_1.py`)
- DAQ-MCU commands and higher-level functions (`../daq_mcu/avr64ea28_daq_mcu.py`)
