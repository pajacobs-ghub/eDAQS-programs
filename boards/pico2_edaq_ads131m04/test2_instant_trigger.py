...
# eDAQs triggered when user presses enter in the python terminal
#
...
NSAMPLES = 12288 # should be 3072ms @ 4kHz (OSR 1024)
...
def main(sp, node_id, fileName):
    ...
    daq.set_osr(1024) # OSR of 1024 is 4kHz
    ...
    node.assert_event_line_low()
    

    # Even though sampling started, the DAQ_MCU may still be sampling.
